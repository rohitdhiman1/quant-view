...
export default function CompactDataStatus() {
    ...
    return (
      <div className="flex items-center gap-2">
        ...
        <div className="text-left">
          <div className="text-xs font-medium text-gray-600 dark:text-gray-400">Checking...</div>
        </div>
      </div>
    )
  }
  ...
  const textColor = freshness.isStale ? 'text-red-700 dark:text-red-400' : freshness.needsUpdate ? 'text-yellow-700 dark:text-yellow-400' : 'text-green-700 dark:text-green-400'
  ...
  return (
    ...
    >
      ...
      <div className="text-left">
        ...
        <div className="text-xs text-gray-500 dark:text-gray-400">Updated {age}</div>
      </div>
